...
<script type="text/javascript">
    function dropFromRegister(argument) {
        // body...
        //alert(argument);
        $.ajax({
            type: "POST",
...
<div class="container">
    ...
    <table class="data-table">
      <!--   <caption class="title">Registered Courses</caption> -->
        <thead>
            <tr>
                <th>NO</th>
                <th>course_id</th>
        ...
        $sql="SELECT * FROM getRegistrationRecord('{$username}')";
        //echo $sql;
        ...
        while ($row = pg_fetch_row($result))
        {
             ...
             echo '<tr>
                ...
                <td>'.$row[1].'</td>
                <td>'.$row[2].'</td>
               <td><button name='.'delete'.'$'.$username.'$'.$row[3].'$'.$row[4].'$'.$row[0].'$'.' type="button" onclick="dropFromRegister(this.name)">Drop</button></td>
            </tr>';
        ...
        <tfoot>
            <tr>
                <th colspan="3">Total Registered Credits</th>
                <th><?=($credits)?></th>
            </tr>
        </tfoot>
